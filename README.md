...
> $ git clone https://github.com/mengqinghao/mengqinghao.github.io.git

或者直接[下载博客](https://github.com/mengqinghao/mengqinghao.github.io/archive/master.zip)   

进mengqinghao.github.io/ 目录下， 开启本地服务 
...
如果在部署博客的时候发现问题，可以直接在[Issues](https://github.com/mengqinghao/mengqinghao.github.io/issues)里面提问。        
...
如果你只想要我博客里的头像效果，你只需要拿 mengqinghao.github.io/_includes/side-panel.html 文件里面 `头像效果` 和 mengqinghao.github.io/css/main.css 里面最后面 `头像效果` 部分就行了。
